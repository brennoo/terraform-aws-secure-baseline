...
| <a name="input_allow_cross_account_vpc_flow_logs_push"></a> [allow\_cross\_account\_vpc\_flow\_logs\_push](#input\_allow\_cross\_account\_vpc\_flow\_logs\_push) | A boolean that indicates whether to allow cross account to push vpc flow logs to current account audit bucket. | `bool` | `false` | no |
